...
import center from '@/views/center'
    import discussguangchang from '@/views/modules/discussguangchang/list'
    import guangchang from '@/views/modules/guangchang/list'
...
const routes = [{
    ...
    children: [{
      ...
      ,{
	path: '/discussguangchang',
        name: '广场评论',
        component: discussguangchang
      }
      ,{
	path: '/guangchang',
        name: '广场',
